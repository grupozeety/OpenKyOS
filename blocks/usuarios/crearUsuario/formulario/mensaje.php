...
//---------------Inicio Formulario (<form>)--------------------------------
    ...
    if ($_REQUEST['mensaje'] == 'confirma') {
        ...
        $tipo = 'error';
        $mensaje =  $this->lenguaje->getCadena('mensajeError'). $_REQUEST ['usuario'] . ". <br> Porfavor verifique que el usuario no se encuentre registrado aún e intente nuevamente.";
        $boton = "regresar";
