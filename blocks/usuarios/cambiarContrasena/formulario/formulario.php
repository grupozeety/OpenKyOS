...
// 		$esteRecursoMenuDB = $this->miConfigurador->fabricaConexiones->getRecursoDB ( $conexion2 );
		...
		$usuario=$respuesta['fname'][0];
		
		$atributos ['tipoEtiqueta'] = 'inicio';
				// Aplica atributos globales al control
		echo $this->miFormulario->formulario ( $atributos );

			$esteCampo = "cambioContrasena";
			$atributos ['id'] = $esteCampo;
			...
			$atributos ['validar'] = 'required, minSize[8],maxSize[15],custom[onlyLetterNumber], custom[passwordold]';
			...
			$atributos ['tabIndex'] = $tab;
			$atributos ['etiqueta'] = $this->lenguaje->getCadena ( $esteCampo );
			$atributos ['validar'] = 'required, minSize[8],maxSize[15],custom[onlyLetterNumber], custom[firstDate], custom[passwordnew]';
			...
			$atributos ['tabIndex'] = $tab;
			$atributos ['etiqueta'] = $this->lenguaje->getCadena ( $esteCampo );
			$atributos ['validar'] = 'required, minSize[8],maxSize[15],custom[onlyLetterNumber], custom[greaterThan]';
