...
class Formulario
{
    ...
    public function formulario()
    {
        ...
        if (isset($_REQUEST['id']) && $_REQUEST['id'] != '') {
            ...
            $cargueDatos = $this->esteRecursoDB->ejecutarAcceso($cadena_sql, "busqueda")[0];
            $_REQUEST = array_merge($_REQUEST, $cargueDatos);
        ...
        $esteCampo = 'ficheros';
        $atributos['id'] = $esteCampo;
        $atributos['leyenda'] = $titulo . "de Cabecera";
        ...
        if ($_REQUEST['opcion'] == 'actualizacion') {
            $valorCodificado .= "&opcion=actualizarCabecera";

            $valorCodificado .= "&id_cabecera=" . $_REQUEST['id'];
        } else {
