...
class Enviar
{
    ...
    public function recuperarClave($datosConexion, $destinatario, $link, $usuario)
    {
        ...
        $mail->addAddress(base64_decode($destinatario), $usuario);
...
<div style="width: 640px; font-family: Arial, Helvetica, sans-serif; font-size: 11px;">
  ...
  <div align="center">
    ...
    public function crearUsuario($datosConexion, $destinatario, $usuario, $contrasena, $link, $rol)
    {
        ...
        // Set the subject line
        $mail->Subject = 'Creación de Cuenta';
...
<div style="width: 640px; font-family: Arial, Helvetica, sans-serif; font-size: 11px;">
  <h1>Nueva Cuenta</h1>
  <p>Ha sido creada una nueva cuenta a su nombre, con la siguiente información: <br>Usuario: ';
        $body .= $usuario;
        $body .= '<br> Contraseña: ';
        $body .= $contrasena;
        $body .= '<br> Rol: ';
        $body .= $rol;
        $body .= '<br>Para iniciar sesión de clic sobre el siguiente link <a href="';
        $body .= $link;
        $body .= '">Conexiones Digitales</a>. <br><b>Por favor cambie su contraseña cuando ingrese al sistema, dirigiéndose al menú Mi Cuenta -> Cambio de Clave. </b></p>
  <div align="center">
  </div>
</div>
</body>
