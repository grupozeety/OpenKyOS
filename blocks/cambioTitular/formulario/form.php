...
namespace cambioTitular\formulario;
	...
	public function seleccionarForm() {
		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			
			{
				...
				$atributos ['id'] = $esteCampo;
				$atributos ['leyenda'] = "Consulta de Titular";
		...
		
		{
			...
			$valorCodificado = "actionBloque=cambioTitular";
			$valorCodificado .= "&pagina=cambioTitular";
			$valorCodificado .= "&bloque=cambioTitular";
			$valorCodificado .= "&bloqueGrupo=" . $esteBloque ["grupo"];
			$valorCodificado .= "&opcion=actualizarTitular";
			/**
