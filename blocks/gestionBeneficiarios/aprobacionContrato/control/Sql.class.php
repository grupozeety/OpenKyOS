    ...
    public function getCadenaSql($tipo, $variable = '') {
        ...
        switch ($tipo) {
            ...
            case 'consultarContratos':
                $cadenaSql = " SELECT cn.id identificador_contrato, cn.numero_contrato, bn.nombre||' '||bn.primer_apellido||' '||bn.segundo_apellido nombre_beneficiario, bn.id identificador_beneficiario, bn.identificacion ";
                $cadenaSql .= " FROM interoperacion.contrato cn";
                $cadenaSql .= " JOIN parametros.parametros pm ON pm.id_parametro=cn.estado_contrato AND pm.descripcion='Borrador' AND pm.estado_registro=TRUE";
