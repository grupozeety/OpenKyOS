...
//         echo $this->miFormulario->formulario ( $atributos );
        ...
        // ----------------INICIO CONTROL: Ventana Modal Confirmación Eliminar Beneficiario---------------------------------
        ...
        echo '<div style="text-align:center;">';
  			...
  			echo '<p><h5>' . $this->lenguaje->getCadena ( "eliminarBeneficiario" ) . '</h5></p>';
        ...
        // -----------------FIN CONTROL: Ventana Modal Confirmación Eliminar Beneficiario -----------------------------------------------------------
        ...
        echo '<p><h5>' . $this->lenguaje->getCadena ( "beneficiarioEliminado" ) . '</h5></p>';
        ...
        // -----------------FIN CONTROL: Ventana Modal Beneficiario Eliminado -----------------------------------------------------------
        ...
        echo '<p><h5>' . $this->lenguaje->getCadena ( "beneficiarioNoEliminado" ) . '</h5></p>';
