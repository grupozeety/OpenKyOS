...
class Sql extends \Sql {
	...
	public function getCadenaSql($tipo, $variable = "") {
		...
		switch ($tipo) {
			...
			case "comisionador" :
				$cadenaSql = " SELECT value, data FROM ";
				$cadenaSql .= " (SELECT usr.mail as data, usr.firstname||' '||lastname as value";
			...
			case 'consultarAgenda' :
				...
				$cadenaSql = " SELECT * FROM interoperacion.agendamiento_comisionamiento ";
				$cadenaSql .= " WHERE consecutivo=" . $variable . " ;";
				break;
