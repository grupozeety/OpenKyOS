...
class Formulario {
	...
	function formulario() {
		...
		$cadenaSql = $this->miSql->getCadenaSql ( 'consultarInformacionRestauracion', $datos );
		$resultado = $this->esteRecursoDB->ejecutarAcceso ( $cadenaSql, "busqueda" ) [0];
		...
		$valorCodificado .= "&token=" . $_REQUEST ['token'];
		/**
	...
	public function mensaje() {
		...
		switch ($_REQUEST ['mensaje']) {
			...
			case 'error' :
				...
				$atributos ["mensaje"] = "No existe el usuario ingresado o no tiene relacionada una cuenta de correo para enviar la información necesaria para la restauración de la contraseña.";
				break;
			...
			case 'errorEnlace' :
				$estilo_mensaje = 'error'; // information,warning,error,validation
				$atributos ["mensaje"] = "El enlace de restauración ya fue utilizado o no es valido. <br> Por favor genere un nuevo enlace de restauración de contraseña.";
				break;
		}
		// ------------------Division para los botones-------------------------
