<?php
namespace gestionCapacitaciones\apropiacion\frontera;
...
class Apropiacion
{
    ...
    public function __construct($lenguaje, $formulario, $sql)
    {
        ...
        $this->gestionApropiacion();
    }
    public function gestionApropiacion()
    {
        ...
        if (isset($_REQUEST['opcion']) && $_REQUEST['opcion'] == 'actualizarApropiacion') {
        ...
        if (isset($_REQUEST['opcion']) && $_REQUEST['opcion'] == 'actualizarApropiacion') {
            $atributos['leyenda'] = "<b>Actualización Apropiación</b>";
        } else {
            $atributos['leyenda'] = "<b>Registro Apropiación</b>";
        }
        ...
        $atributos['id'] = $esteCampo;
        $atributos['leyenda'] = "Información con Respecto a la Apropiación";
        echo $this->miFormulario->agrupacion('inicio', $atributos);
        unset($atributos);
        {
            ...
            $cadenaSql = $this->miSql->getCadenaSql('consultarTipoActividad');
            ...
            $atributos['columnas'] = 1;
            $atributos['tamanno'] = 1;
            $atributos['placeholder'] = "Seleccione Fecha Apropiación";
            if (isset($_REQUEST[$esteCampo])) {
                $atributos['valor'] = $_REQUEST[$esteCampo];
            } else {
                $atributos['valor'] = "";
        ...
        //echo "<input type='button' id='limpiarBn' style='float:right' class='btn btn-default' value='Limpiar Apropiación'>";
        ...
        $esteCampo = 'AgrupacionGeneral';
        $atributos['id'] = $esteCampo;
        $atributos['leyenda'] = "Información Apropiación";
        echo $this->miFormulario->agrupacion('inicio', $atributos);
        unset($atributos);
        {
            ...
            $atributos['columnas'] = 1;
            $atributos['tamanno'] = 1;
            $atributos['placeholder'] = "Ingrese Número de Asistentes a la Actividad";
            if (isset($_REQUEST[$esteCampo])) {
                $atributos['valor'] = $_REQUEST[$esteCampo];
            } else {
                $atributos['valor'] = "";
            ...
            $esteCampo = 'numeroPersonasVisitadas';
            $atributos['id'] = $esteCampo;
            $atributos['nombre'] = $esteCampo;
            $atributos['tipo'] = "number";
            $atributos['minimo'] = 0;
            ...
            $atributos['columnas'] = 1;
            $atributos['tamanno'] = 1;
            $atributos['placeholder'] = "Ingrese Número de Personas Visitadas en el periodo (Esto es solamente para visitas Uno a Uno y mipymes)";
            if (isset($_REQUEST[$esteCampo])) {
                $atributos['valor'] = $_REQUEST[$esteCampo];
            } else {
                $atributos['valor'] = "0";
        ...
        if (isset($_REQUEST['opcion']) && $_REQUEST['opcion'] == 'actualizarApropiacion') {
            $valorCodificado .= "&opcion=actualizarApropiacion";
            $valorCodificado .= "&id_competencia=" . $_REQUEST['id_competencia'];
        } else {
            $valorCodificado .= "&opcion=registrarApropiacion";
        }
    ...
    public function mensajeModal()
    {
        ...
        switch ($_REQUEST['mensaje']) {
            case 'exitoRegistro':
                $mensaje = "Exito<br>Apropiación Registrada";
                $atributos['estiloLinea'] = 'success'; //success,error,information,warning
                break;

            case 'errorRegistro':
                $mensaje = "Error<br>Registro de Apropiación";
...
$miSeleccionador = new Apropiacion($this->lenguaje, $this->miFormulario, $this->sql);
