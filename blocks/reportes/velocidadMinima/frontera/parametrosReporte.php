<?php
namespace reportes\velocidadMinima\frontera;
/**
...
class Registrador {
    ...
    public function seleccionarForm() {
        ...
        echo $this->miFormulario->formulario($atributos);
        {
            ...
            $atributos['id'] = $esteCampo;
            $atributos['leyenda'] = "<b>Reporte Indicador de Velocidad Mínima</b>";
            ...
            $atributos['columnas'] = 1;
            $atributos['tamanno'] = 1;
            $atributos['placeholder'] = "Seleccione Fecha del reporte";
            $atributos['valor'] = "";
            $atributos['ajax_function'] = "";
            $atributos['ajax_control'] = $esteCampo;
            $atributos['limitar'] = false;
