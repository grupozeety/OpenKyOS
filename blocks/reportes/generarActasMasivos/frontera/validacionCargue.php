<?php
namespace reportes\generarActasMasivos\frontera;
...
class Registrador {
    ...
    public function seleccionarForm() {
        ...
        echo $this->miFormulario->formulario($atributos);
        {
            ...
            $atributos['id'] = $esteCampo;
            $atributos['leyenda'] = "Cargue Masivo Actas Portatil y Servicios";
            ...
            unset($atributos);
            {
                ...
                $matrizItems = array(
                    ...
                    array(
                        '2',
                        'Cargar y Crear Actas',
                    ),
                    array(
                        '3',
                        'Consultar Estado Generación Actas',
                    ),
                );
                ...
                unset($atributos);
                {
                    ...
                    $esteCampo = "archivo_actas"; // Código documento
                    $atributos["id"] = $esteCampo;
                    $atributos["nombre"] = $esteCampo;
                    $atributos["tipo"] = "file";
                    $atributos["obligatorio"] = true;
