<?php
namespace reportes\porcentajeConsumoMateriales\frontera;
/**
...
class Registrador {
    ...
    public function seleccionarForm() {
        ...
        echo $this->miFormulario->formulario($atributos);
        {
            ...
            $atributos['id'] = $esteCampo;
            $atributos['leyenda'] = "Reporte Porcentaje de Consumo de Materiales";
...

            {
                ...
                $atributos['matrizItems'] = array(0 => array(0 => "", 1 => "Sin proyectos"));
