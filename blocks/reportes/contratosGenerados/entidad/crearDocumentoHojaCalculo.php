...
namespace reportes\contratosGenerados\entidad;
...
class GenerarReporteExcelInstalaciones {
    ...
    public function configurarDocumento() {
        ...
        $this->objCal->getProperties()->setCreator("OpenKyOS")->setLastModifiedBy("OpenKyOS")->setTitle("Reporte Contratos Generados")->setSubject("Reporte Contratos Generados")->setDescription("Reporte Contratos Generados")->setCategory("Reporte");
    }
    public function retornarDocumento() {
        ...
        header('Content-Disposition: attachment;filename="Reporte Contratos Generados ' . date("Y-m-d") . '.xlsx"');
