...
class Entidad {
    ...
    public function procesarParametrizacion() {
        include_once $this->ruta . "entidad/procesarParametrizacion.php";
    }
    public function action() {
        ...
        if (isset($_REQUEST['opcion'])) {
            switch ($_REQUEST['opcion']) {
                case 'procesarParametrizacion':

                    $this->procesarParametrizacion();
