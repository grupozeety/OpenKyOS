...
namespace reportes\plantillaFamiliares\frontera;
...
class Registrador {
    ...
    public function seleccionarForm() {
        ...
        echo $this->miFormulario->formulario($atributos);
        {
            ...
            $atributos['id'] = $esteCampo;
            $atributos['leyenda'] = "Cargue Masivo Familiares Beneficiarios Conexiones Digitales II";
...

                    {
                        ...
                        unset($atributos);
                        {
                            ...
                            $mensaje = 'Cargar Formato para Validar que:<br>
                                                1. Existencia de un beneficiario registrado.<br>
                ...
                unset($atributos);
                {

                    {
                        ...
                        unset($atributos);
                        {
                            ...
                            $atributos["tamanno"] = '';
                            $atributos["etiqueta"] = '';
                            $mensaje = 'Cargar Formato Familiares Beneficiarios:<br>
                                                Recordar que no se generará ningún registro de beneficiario con información incompleta.<br>
