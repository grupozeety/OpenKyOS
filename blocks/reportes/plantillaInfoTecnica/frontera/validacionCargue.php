...
namespace reportes\plantillaBeneficiario\frontera;
...
class Registrador {
	...
	public function seleccionarForm() {
		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			$atributos ['id'] = $esteCampo;
			$atributos ['leyenda'] = "Cargue Masivo Información Técnica Conexiones Digitales II";
					...
					
					{
						...
						unset ( $atributos );
						{
							
							{
								...
								$url .= 'plantilla_cargueInfoTecnica_HFC.xls';
								
								// URL base
								$url2 = $this->miConfigurador->getVariableConfiguracion ( "host" );
								$url2 .= $this->miConfigurador->getVariableConfiguracion ( "site" );
								$url2 .= '/archivos/generacionMasiva/plantillas/';
								$url2 .= 'plantilla_cargueInfoTecnica_wMAN.xls';
							}
							...
							$mensaje = 'Cargar Formato para Validar que:<br>
                                                ...
                                                2. En caso de actualización de registro, la existencia de las cabeceras, nodos y celdas relacionados.<br>
                                                3. El número de datos a cargar no sobrepase a 500.<br>
                                        ...
                                        Link de Descarga de Plantilla<br><br><b>HFC: <b><a target="_blank" href="' . $url . '">Plantilla Cargue Masivo HFC</a></b><br>
                                        		                         <b>wMAN: <b><a target="_blank" href="' . $url2 . '">Plantilla Cargue Masivo wMAN</a></b><br>
                                                ';
				...
				unset ( $atributos );
				{
					
					{
						...
						unset ( $atributos );
						{
							...
							$atributos ["tamanno"] = '';
							$atributos ["etiqueta"] = '';
							$mensaje = 'Cargar Formato Información Técnica:<br>
	...
	public function mensajeModal() {
		switch ($_REQUEST ['mensajeModal']) {
			...
			case 'errorTecnologia' :
				$mensaje = "Error<br>La información del cargue no coincide con la tecnología elegida";
				$atributos ['estiloLinea'] = 'error'; // success,error,information,warning
				break;
