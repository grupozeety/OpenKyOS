        ...
        switch ($tipo) {
            ...
            case 'consultarUrbanizacion':
                ...
                case 'consultarInformacion':
                  $cadenaSql=" SELECT id_info_llam, ";
                  $cadenaSql.=" extract(month from t1) as id_mes, ";
                  $cadenaSql.=" cast(extract(year from t1) as character varying) as annio, ";
                  ...
                  $cadenaSql.=" CASE condicion_obtenida WHEN TRUE then 'Exito' WHEN FALSE then 'Fallido' END as condicion_obtenida ";
                ...
                case 'consultarInformacionB':
                  $cadenaSql=" SELECT fecha, ";
                  $cadenaSql.=" sum(total_llam) as total_llamadas, ";
                  $cadenaSql.=" sum(person_llam) as person_llamadas, ";
                  $cadenaSql.=" sum(dentro_llam) as dentro_llamadas, ";
                  $cadenaSql.=" sum(fuera_llam) as fuera_llamadas , ";
                  ...
                  $cadenaSql.=" GROUP BY fecha";
                  $cadenaSql.=" UNION ";
                  $cadenaSql.=" SELECT to_char(t1,'yyyy-MM') as fecha,0 as total_llam, 0 as person_llam, 0 as dentro_llam, count(id_info_llam) as fuera_llam ";
                  $cadenaSql.=" FROM logica.info_llam ";
                  $cadenaSql.=" WHERE estado_registro=TRUE ";
                  $cadenaSql.=" AND tipo_llamada='1' ";
                  $cadenaSql.=" AND extract(EPOCH from (t3-t2))>20 ";
                  ...
                  $cadenaSql.=" GROUP BY fecha ORDER BY fecha DESC ";
                ...
                case 'consultarInformacionC':
                  ...
                  $cadenaSql.=" sum(fuera_llam) as fuera_llamadas , ";
                  $cadenaSql.=" coalesce((sum(dentro_llam)/nullif(sum(person_llam),0))*100,0) as calculo_indicador";
                  $cadenaSql.=" FROM (SELECT to_char(t1,'yyyy-MM') as fecha, ";
                  $cadenaSql.=" count(id_info_llam) as total_llam, ";
                  $cadenaSql.=" 0 as person_llam, ";
                  $cadenaSql.=" 0 as dentro_llam, ";
                  $cadenaSql.=" 0 as fuera_llam ";
                  $cadenaSql.=" FROM logica.info_llam ";
                  $cadenaSql.=" WHERE estado_registro=TRUE ";
                  $cadenaSql.=" GROUP BY fecha ";
                  $cadenaSql.=" UNION ";
                  $cadenaSql.=" SELECT to_char(t1,'yyyy-MM') as fecha, ";
                  $cadenaSql.=" 0 as total_llam, ";
                  $cadenaSql.=" count(id_info_llam) as person_llam, ";
                  $cadenaSql.=" 0 as dentro_llam, ";
                  $cadenaSql.=" 0 as fuera_llam ";
                  $cadenaSql.=" FROM logica.info_llam ";
                  $cadenaSql.=" WHERE estado_registro=TRUE ";
