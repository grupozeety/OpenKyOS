    ...
    function formulario() {
        ...
        */
        ...
        if(isset($_REQUEST['id']) && $_REQUEST['id'] != ''){
        	$cadena_sql = $this->miSql->getCadenaSql ( "cargarNodo", $_REQUEST['id'] );
        ...
        $esteCampo = 'ficheros';
        $atributos ['id'] = $esteCampo;
        $atributos ['leyenda'] = "Registro de Celda o Nodo EOC";
        echo $this->miFormulario->agrupacion ( 'inicio', $atributos );
        unset ( $atributos );
        
        // ----------------INICIO CONTROL: Campo Texto Código de la Celda o Nodo EOC--------------------------------------------------------
        ...
        // ----------------FIN CONTROL: Campo Texto Código de la Celda o Nodo EOC--------------------------------------------------------
        ...
        $esteCampo = 'infoNodo';
        $atributos ['id'] = $esteCampo;
        $atributos ['leyenda'] = "Información de Celda";
        echo $this->miFormulario->agrupacion ( 'inicio', $atributos );
        unset ( $atributos );
        
		        // ----------------INICIO CONTROL: Campo Texto Total Nodo Hasta Punto de Ingreso--------------------------------------------------------
		        
		        $esteCampo = 'mac_master_eoc';
		        $atributos ['nombre'] = $esteCampo;
		        $atributos ['tipo'] = "text";
		        $atributos ['id'] = $esteCampo;
		        $atributos ['etiqueta'] = $this->lenguaje->getCadena ( $esteCampo );
	        ...
	        $esteCampo = 'infoCelda';
	        $atributos ['id'] = $esteCampo;
	        $atributos ['leyenda'] = "Información de Nodo EOC";
	        echo $this->miFormulario->agrupacion ( 'inicio', $atributos );
	        unset ( $atributos );
        ...
        */
        ...
        $valorCodificado .= "&opcion=registrarNodo";
        /**
