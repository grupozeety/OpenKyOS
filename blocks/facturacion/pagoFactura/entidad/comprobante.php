...
class GenerarDocumento {
	...
	public function contenidoDocumento() {
		...
		$diferencia=$_REQUEST['valor_recibido']-$_REQUEST['valor_factura'];
		...
		$table = "<br><table style='margin: 0 auto;border-collapse:collapse;border:1px;width:100%;' nowrap >
                            ...
                            <tr>
                                ...
                                <td style='height:13px;text-align:left;border:none;border-spacing: 3px'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ ". number_format ( $diferencia, 2, '.', ',' ). "</td>
                            </tr>
                            <tr>
