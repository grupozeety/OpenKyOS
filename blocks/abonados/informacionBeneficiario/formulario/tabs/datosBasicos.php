...
//         unset($atributos);
        ...
        if (isset($_REQUEST['id'])) {
            ...
            if (count($cargueDatos) > 1) {
                ...
                $documentos = substr($documentos, 0, (strlen($documentos) - 3));
...
//             //$atributos['validar'] = 'required';
...

            {
                ...
                if (isset($cargueDatos[$esteCampo])) {
                    $atributos['valor'] = $cargueDatos[$esteCampo];
                    echo '<img id="imagen" src="' . $cargueDatos[$esteCampo] . $cargueDatos['nombre_foto'] . '" width="300" height="300">';
                } else {
                    $atributos['valor'] = '';
                }
...
//             $atributos = array_merge($atributos, $atributosGlobales);
        ...
        echo '</div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Información de Ubicación</a>
                        </h3>
                    </div>
