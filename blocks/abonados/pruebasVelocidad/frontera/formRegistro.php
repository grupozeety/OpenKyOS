...
class Formulario {
	...
	function formulario() {
		...
		$esteCampo = 'ficheros';
		$atributos ['id'] = $esteCampo;
		$atributos ['leyenda'] = "Pruebas de Velocidad";
		...
		echo '
				<h2 style="visibility: visible; animation-name: fadeInDown;" class="section-title text-center wow fadeInDown animated">Alta Calidad</h2>
				<p style="visibility: visible; animation-name: fadeInDown;" class="text-center wow fadeInDown animated">Puedes verificar la calidad de nuestro servicio de
					Internet a través de un sencillo medidor de velocidad. En tiempo
					real medirá el estado de tu conexión!!!</p>
			';
		
									echo '
				<img style="visibility: visible; animation-name: fadeIn;" class="img-responsive center-block wow fadeIn animated" src="' . $rutaBloque . '/frontera/css/imagen/gauge.png" alt="">
				<p style="visibility: visible; animation-duration: 300ms; animation-delay: 200ms; animation-name: fadeInUp;" class="wow fadeInUp animated" data-wow-duration="300ms" data-wow-delay="200ms">
					 <center> <a class="btn btn-primary btn-lg" href="http://speedtest.politecnica.edu.co/">Haz la
						prueba ahora!!</a> </center> 
				</p>';
