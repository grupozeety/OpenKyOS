		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			
			{
				...
				echo '<section id="intro">
					  ...
					  ' . $infoCertificado['serial_esc'] . '
					  </h4>
		        	  <img src="' . $this->rutaURL .'/frontera/css/imagen/prevail.png" alt="" class="animate-intro fadeInUp animated">
					  <p></p>
					  </div> <!-- /twelve -->
   					  </div> <!-- /row -->
					  </section> <!-- /intro -->
					  ...
					  <div class="bgrid feature animate-this fadeInUp animated">
					  <span class="feature-count">Mac 1</span>
					  <div class="feature-content">
					  <h3>
					  ' . $infoCertificado['mac_esc'] . '
					  </h3>
					  </div>
					  </div> <!-- /bgrid -->
					  <div class="bgrid feature animate-this fadeInUp animated">
				 	  <span class="feature-count">Mac 2</span>
					  <div class="feature-content">
					  <h3>
					  ' . $infoCertificado['mac2_esc'] . '
					  </h3>
					  </div>
					  </div> <!-- /bgrid -->
					  <div class="bgrid feature animate-this fadeInUp animated">
					  <span class="feature-count">Marca</span>
					  <div class="feature-content">
					  <h3>
					  ' . $infoCertificado['marca_esc'] . '
					  </h3>
					  </div>
					  </div> <!-- /bgrid -->
					  <div class="bgrid feature animate-this fadeInUp animated">
					  <span class="feature-count">IP</span>
					  <div class="feature-content">
					  <h3>
					  ' . $infoCertificado['ip_esc'] . '
					  </h3>
					  </div>
					  </div> <!-- /bgrid -->
					  <div class="bgrid feature animate-this fadeInUp animated">
					  <span class="feature-count">Cantidad</span>
					  <div class="feature-content">
					  <h3>
					  ' . $infoCertificado['cant_esc'] . '
					  </h3>
					  </div>
					  </div> <!-- /bgrid -->
				      </div> <!-- /features-list -->
