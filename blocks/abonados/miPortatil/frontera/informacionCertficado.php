			...
			
			{
				...
				echo '<section id="intro">
            		  <div class="row intro-content">
   		           	  ...
   		           	  <h3 class="animate-intro fadeInUp animated">GNU/Linux Ubuntu</h3>
					  <h4 class="animate-intro fadeInUp animated">
					  ' . $infoCertificado['serial'] . '
					  </h4>
					  <div class="buttons">
					  <a class="button stroke animate-intro fadeInUp animated" href="' . $this->rutaURL . '/frontera/css/imagen/4AA5-7737SPL.pdf" target="_blank" title="">Características</a>
					  <a class="button stroke animate-intro fadeInUp animated" href="' . $this->rutaURL . '/frontera/css/imagen/ubuntu-manual-es.pdf" target="_blank" title="">Manual Completo</a>
					  </div>					
					  <img src="' . $this->rutaURL . '/frontera/css/imagen/1.png" alt="" class="animate-intro fadeInUp animated">
					  <p></p>
					  </div> <!-- /twelve --> 		   			
   					  </div> <!-- /row -->   
					  </section> <!-- /intro -->
					  <section id="features">
				   	  <div class="row section-intro group animate-this fadeInUp animated">
					  <div class="col-twelve with-bottom-line">
					  <img src="' . $this->rutaURL . '/frontera/css/imagen/cpu.png"  width="50" height="50" alt="" class="animate-intro fadeInUp animated"> 
					  <h2 class="">Procesador</h2>
					  </div>
					  </div>
					  <div class="row features-wrap">
					  <div class="features-list block-1-3 block-s-1-2 block-tab-full">
					  <div class="bgrid feature animate-this fadeInUp animated">
					  <span class="feature-count">Serial</span>
					  ...
					  <div class="bgrid feature animate-this fadeInUp animated">
					  <span class="feature-count">Fabricante</span>
				 	  <div class="feature-content">
					  <h3>
					  ' . $infoCertificado['cpu_fabricante'] . '
					  </h3>
					  </div>
					  </div> <!-- /bgrid -->
					  <div class="bgrid feature animate-this fadeInUp animated">
					  <span class="feature-count">Modelo</span>
					  <div class="feature-content">
					  <h3>
					  ' . $infoCertificado['cpu_version'] . '
					  </h3>
					  </div>
					  </div> <!-- /bgrid -->
					  <div class="bgrid feature animate-this fadeInUp animated">
					  <span class="feature-count">Núcleos</span>
				      <div class="feature-content">
					  <h3>
					  ' . $infoCertificado['cpu_cantidad_nucleos'] . '
					  </h3>
					  </div>
					  </div> <!-- /bgrid -->
					  <div class="bgrid feature animate-this fadeInUp animated">
					  <span class="feature-count">Velocidad</span>
					  <div class="feature-content">
					  <h3>
					  ' . $infoCertificado['cpu_velocidad'] . '
					  </h3>
					  </div>
					  </div> <!-- /bgrid -->
					  <div class="bgrid feature animate-this fadeInUp animated">
					  <span class="feature-count">Bits</span>
					  <div class="feature-content">
					  <h3>
					  ' . $infoCertificado['cpu_bits'] . '
					  </h3> 
					  </div>
					  </div> <!-- /bgrid -->
					  </div> <!-- /features-list -->
					  ...
					  <div class="row section-intro group animate-this fadeInUp animated">
					  <div class="col-twelve with-bottom-line">
					  <img src="' . $this->rutaURL . '/frontera/css/imagen/board.png" width="50" height="50" alt="" class="animate-intro fadeInUp animated"> 
					  <h2 class="">Tarjeta Madre</h2>
					  </div>
					  </div>
					  <div class="row features-wrap">
					  <div class="features-list block-1-3 block-s-1-2 block-tab-full">
					  ...
					  <div class="feature-content">
					  <h3>
					  ' . $infoCertificado['board_fabricante'] . '
					  </h3>
					  </div>
					  </div> <!-- /bgrid -->
					  <div class="bgrid feature animate-this fadeInUp animated">
