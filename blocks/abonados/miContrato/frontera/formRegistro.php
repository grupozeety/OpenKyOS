...
class Formulario {
	...
	function formulario() {
		...
		$esteCampo = 'ficheros';
		$atributos ['id'] = $esteCampo;
		$atributos ['leyenda'] = "Contrato";
		echo $this->miFormulario->agrupacion ( 'inicio', $atributos );
		unset ( $atributos );
		
		$cadenaSql = $this->miSql->getCadenaSql("consultarContrato");
		$contrato = $esteRecursoDB->ejecutarAcceso($cadenaSql, "busqueda")[0];

		echo '<embed src="' . $contrato['ruta_documento_contrato'] . '" width="100%" height="500" href="' . $contrato['ruta_documento_contrato'] . '"></embed>';
