...
class InspectorHTML
{
    ...
    public function limpiarPHPHTML($arreglo, $excluir = "")
    {
            ...
            if (!in_array($clave, $variables)) {
                ...
                if (is_array($valor)) {
                    ...
                    foreach ($valor as $key => $value) {
                        $contenido[$key] = strip_tags($value);

                    }

                    $arreglo[$clave] = $contenido;
    ...
    public function limpiarSQL($arreglo, $excluir = "")
    {
        ...
        foreach ($arreglo as $clave => $valor) {
            if (!in_array($clave, $variables)) {
                ...
                if (is_array($valor)) {
                    ...
                    foreach ($valor as $key => $value) {
                        $contenido[$key] = addcslashes($value, '%_');
     ...
     */
    public function validarCampo($valorCampo, $parametros, $corregir = false, $showError = false)
    {
     ...
     */
    public function validacionCampos($variables, $validadorCampos, $corregir = false, $showError = false)
    {
     ...
     */
    public function codificarCampos($valor)
    {
     ...
     */
    public function decodificarCampos($valor)
    {
